...
prefix dbo: lt;http://dbpedia.org/ontology/populationTotal/gt;
...
INSERT { :Santi_Cazorla dbp:position :Attacker .}
WHERE{}
    			</textarea>
				<br>
		...
		<br>-->
				<label for="format" class="n">Choose Semantics</label> <select
					...
					<option value="text/html" selected="selected">Brave</option>
					<option value="text/x-html+tr">Cautious</option>
				</select> <br></br> <label class="n" for="options">Options</label>
				<fieldset id="options">
